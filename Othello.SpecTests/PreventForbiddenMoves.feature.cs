...
namespace Othello.SpecTests
{
    ...
    public partial class PreventForbiddenMovesFeature : object, Xunit.IClassFixture<PreventForbiddenMovesFeature.FixtureData>, System.IDisposable
    {
...
#line 1 "PreventForbiddenMoves.feature"
#line hidden
        
        public PreventForbiddenMovesFeature(PreventForbiddenMovesFeature.FixtureData fixtureData, Othello_SpecTests_XUnitAssemblyFixture assemblyFixture, Xunit.Abstractions.ITestOutputHelper testOutputHelper)
        {
        ...
        public static void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "", "Prevent forbidden moves", null, ProgrammingLanguage.CSharp, ((string[])(null)));
...
#line hidden
#line 4
 testRunner.Given("an initial Othello board is created", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Given ");
#line hidden
        }
        ...
        [Xunit.SkippableTheoryAttribute(DisplayName="Cannot place a disc in any of the already filled square of the central 2x2 grid")]
...
#line hidden
        ...
        [Xunit.SkippableTheoryAttribute(DisplayName="Cannot place a disc in a position that is not (8-way) adjacent to any disc")]
        [Xunit.TraitAttribute("FeatureTitle", "Prevent forbidden moves")]
        [Xunit.TraitAttribute("Description", "Cannot place a disc in a position that is not (8-way) adjacent to any disc")]
        [Xunit.InlineDataAttribute("a1", "Black", new string[0])]
        [Xunit.InlineDataAttribute("b2", "Black", new string[0])]
        [Xunit.InlineDataAttribute("c2", "Black", new string[0])]
        [Xunit.InlineDataAttribute("d2", "White", new string[0])]
...
#line hidden
#line 47
 testRunner.Then("an error is issued saying \"Your disc must be adjacent to another one (vertically," +
                        " horizontally or diagonally).\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            }
            this.ScenarioCleanup();
        }
        ...
        public class FixtureData : System.IDisposable
        {
            ...
            public FixtureData()
            {
                PreventForbiddenMovesFeature.FeatureSetup();
            }
            
            void System.IDisposable.Dispose()
            {
                PreventForbiddenMovesFeature.FeatureTearDown();
            }
        }
    }
}
